# Dataset Collection
Big reports, source corpus and goldset are collected from https://github.com/masud-technope/BLIZZARD-Replication-Package-ESEC-FSE2018/tree/master (Improving IR-Based Bug Localization with Context-Aware Query Reformulation)
...
Subsets of Bug Reports - Unzip RQ3.zip. Different subsets of bug reports can be found here based on their QE values.
